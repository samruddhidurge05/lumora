/**
 * SettlementReceiptModal.jsx
 * ---------------------------
 * Printable / downloadable settlement receipt.
 * Matches Lumora admin design system.
 *
 * Props:
 *   settlement  — full settlement detail object
    ...
    <AnimatePresence>
      ...
      >
        ...
        <motion.div
          ...
          id="settlement-receipt-printable"
        >
          {/* Header */}
          <div className="px-6 pt-6 pb-4 border-b border-[#8E6AA8]/10 flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <h3 className="text-sm font-serif font-black text-[#2D004D] leading-tight">Settlement Record</h3>
              </div>
            </div>
            <button
              onClick={onClose}
          ...
          <div className="px-6 py-5 text-center border-b border-[#8E6AA8]/10 bg-gradient-to-b from-[#D8BFE3]/10 to-transparent">
            <p className="text-[10px] font-extrabold tracking-widest text-[#8E6AA8] uppercase mb-1">Settlement Amount</p>
          ...
          <div className="px-6 py-2">
            <Field label="Settlement ID"       value={`#${settlement.id}`} mono />
          ...
          <div className="px-6 py-4 border-t border-[#8E6AA8]/10 bg-[#D8BFE3]/5">
            <p className="text-[9px] text-[#8E6AA8] text-center leading-relaxed mb-3">
              This is an internal treasury record generated by the Lumora Admin Console.
