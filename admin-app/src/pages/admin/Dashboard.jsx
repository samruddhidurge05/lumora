...
export default function Dashboard() {
  ...
  const metricModalDetails = {
    totalRevenue:   { title: "Revenue Overview",         desc: "Aggregated gross sales across all paid orders this period.", data: metricModalData.totalRevenue   || [] },
    ordersToday:    { title: "Today's Orders",           desc: "Total transaction counts per month over the last 5 months.", data: metricModalData.ordersToday    || [] },
    conversionRate: { title: "Conversion Rate",          desc: "Percentage of orders that were paid vs total orders placed.", data: metricModalData.conversionRate || [] },
    ...
    refundRate:     { title: "Refund Rate",              desc: "Refund rate per month — refunded orders / total orders.", data: metricModalData.refundRate     || [] },
    growthVelocity: { title: "Growth Trend",             desc: "Month-over-month revenue growth percentage trend.", data: metricModalData.growthVelocity  || [] },
  };
            ...
            actions={
              <div className="flex items-center gap-4 sm:gap-6 pt-2 md:pt-0">
                <div className="flex flex-col text-right">
                  <span className="text-[8px] font-extrabold tracking-widest text-[#7B3FA0] uppercase">System Health</span>
        ...
        <section className="grid grid-cols-1 lg:grid-cols-12 gap-4 sm:gap-6 lg:gap-8 items-start mb-6 sm:mb-8 md:mb-12">
          ...
          >
            ...
            <div className="text-[9px] text-[#7B3FA0] flex justify-between border-t border-stone-200/50 pt-3">
              <span>{isScanning ? `Scanning Log (${scanProgress}%)` : "System logs verified"}</span>
