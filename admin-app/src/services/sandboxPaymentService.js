/**
 * admin-app/src/services/sandboxPaymentService.js
 * =================================================
...
export const sandboxPaymentService = {
  ...
  async simulatePayout({ payoutId, netAmount, scenario = 'success', notes = '' }) {
    ...
    // Call backend test simulation endpoint or mock response
    try {
      ...
      // Client-side fallback if backend sandbox endpoint operates cleanly
      return {
        success: scenario === 'success',
        payoutId,
        netAmount,
