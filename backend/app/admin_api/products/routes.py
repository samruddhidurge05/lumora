        ...
        "products": [
            {
                ...
                "commission_value":    float(getattr(p, "commission_value", 0) or 0),
                "downloads":   p.downloads or 0,
                "rating":      float(getattr(p, "rating", 5.0) or 5.0),
...
def create_admin_product(
    ...
    return {
        ...
        "commission_value":    float(getattr(new_product, "commission_value", 0) or 0),
...
def update_admin_product(
    ...
    return {
        ...
        "commission_value":         float(getattr(product, "commission_value", 0) or 0),
