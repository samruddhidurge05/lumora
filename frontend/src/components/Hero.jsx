...
const styles = {
  ...
  /* Editorial Headline on background with glowing text shadow */
  title: {
    ...
    margin: 0,
    maxWidth: '900px',
    textShadow: '0 4px 30px rgba(0, 0, 0, 0.95), 0 0 45px rgba(192, 132, 252, 0.40)',
  },
  titleHighlight: {
    fontFamily: 'var(--font-editorial)',
    fontStyle: 'italic',
    fontWeight: 600,
    background: 'linear-gradient(135deg, #FFFFFF 0%, #E9D5FF 25%, #C084FC 75%, #F472B6 100%)',
  ...
  /* Highlighted Subtitle on background with subtle glass backdrop */
  subtext: {
  ...
  ctaSolid: {
    ...
    boxShadow: '0 12px 36px rgba(168, 85, 247, 0.60), 0 0 20px rgba(168, 85, 247, 0.40)',
    display: 'inline-flex',
    alignItems: 'center',
    gap: '8px',
  },
