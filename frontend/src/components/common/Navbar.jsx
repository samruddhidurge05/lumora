    ...
    >
      <div 
        ...
        style={{
          ...
          borderRadius: '100px',
          transition: 'all 0.5s cubic-bezier(0.16, 1, 0.3, 1)',
          background: scrolled ? 'rgba(255, 255, 255, 0.35)' : 'rgba(255, 255, 255, 0.18)',
          backdropFilter: 'blur(24px) saturate(180%)',
          WebkitBackdropFilter: 'blur(24px) saturate(180%)',
          boxShadow: scrolled ? '0 12px 40px rgba(0, 0, 0, 0.12), inset 0 1px 0 rgba(255, 255, 255, 0.5)' : '0 8px 32px rgba(0, 0, 0, 0.08), inset 0 1px 0 rgba(255, 255, 255, 0.4)',
          border: scrolled ? '1.5px solid rgba(255, 255, 255, 0.50)' : '1.5px solid rgba(255, 255, 255, 0.35)',
          position: 'relative',
          overflow: 'visible',
          zIndex: 999999,
        }}
