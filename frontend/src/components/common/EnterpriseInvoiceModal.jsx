            ...
            <div className="mb-6 sm:mb-8 p-4 sm:p-6 rounded-2xl bg-gradient-to-br from-blue-50 via-white to-blue-50/30 border border-blue-200/80 shadow-sm relative overflow-hidden">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5 sm:gap-3 text-xs font-sans">
                ...
                <div className="p-3 bg-white rounded-xl border border-blue-100 overflow-hidden">
                  ...
                  <div className="font-bold text-[#2D004D] mt-0.5 truncate">{order?.download_device || traceData?.download_audit?.device_type || systemInfo.device || 'Desktop'}</div>
                ...
                <div className="p-3 bg-white rounded-xl border border-blue-100 overflow-hidden">
                  ...
                  <div className="font-bold text-[#2D004D] mt-0.5 truncate">{order?.download_browser || traceData?.download_audit?.browser || systemInfo.browser || 'Chrome'}</div>
                ...
                <div className="p-3 bg-white rounded-xl border border-blue-100 overflow-hidden">
                  ...
                  <div className="font-mono font-bold text-stone-800 text-[10px] mt-0.5 truncate">{order?.download_ip || order?.ip_address || traceData?.download_audit?.ip_address || traceData?.customer_ip || '150.107.18.39'}</div>
