...
const ROLES = [
  {
    id: 'customer',
    title: 'Customer',
    desc: 'Browse and purchase premium digital assets.',
    icon: (
  ...
  },
  {
    id: 'affiliate',
    title: 'Affiliate',
    desc: 'Promote top products and earn commissions.',
    icon: (
      <svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="#fff" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    ...
    desc: 'Sell digital creations and track live analytics.',
    icon: (
      <svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="#fff" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    <AuthBackground>
      <div className="auth-container">
        ...
        >
          ...
          <motion.h2 className="card-heading" variants={itemVariants}>Welcome back</motion.h2>
          <motion.p className="card-subheading" variants={itemVariants}>
            Choose your account type to sign in to the right dashboard.
          </motion.p>
          ...
          <motion.div className="signup-prompt" variants={itemVariants}>
            New to Lumora?{' '}
            <a href="/auth/register-selection" onClick={(e) => { e.preventDefault(); navigate('/auth/register-selection'); }}>
              Create your account →
            </a>
          </motion.div>

          <motion.div className="signup-prompt" style={{ marginTop: '8px', fontSize: '0.8rem', opacity: 0.8 }} variants={itemVariants}>
            Platform Administrator?{' '}
            <a href="/auth/login?role=admin" onClick={(e) => { e.preventDefault(); navigate('/auth/login?role=admin'); }}>
              Sign in here →
            </a>
          </motion.div>
