...
export default function Vendor() {
  ...
  /* ── Why Join data ── */
  const whyItems = [
    { icon: <Globe size={22} />, title: 'Global Audience', desc: 'Sell to millions of professionals and creators worldwide.' },
    { icon: <CreditCard size={22} />, title: 'Zero Upfront Fees', desc: 'List unlimited products at no cost — pay only when you sell.' },
    { icon: <Shield size={22} />, title: 'Secure Payouts', desc: 'Automated weekly payouts with full tracking and transparency.' },
    { icon: <Palette size={22} />, title: 'Full Creative Control', desc: 'Set your own prices, branding, and product presentation.' },
  ];

  /* ── How It Works steps ── */
  const steps = [
    { num: '01', title: 'Apply', desc: 'Submit your application in minutes.' },
    { num: '02', title: 'Setup Store', desc: 'Customize your brand profile.' },
    { num: '03', title: 'Upload Products', desc: 'Add products with rich previews.' },
    { num: '04', title: 'Earn', desc: 'Sell and receive weekly payouts.' },
  ];
        ...
        <section style={{ padding: '80px clamp(1.5rem, 6vw, 7rem) 64px', position: 'relative', minHeight: '340px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          ...
          <div style={{ maxWidth: '720px', margin: '0 auto', textAlign: 'center', position: 'relative', zIndex: 2 }}>
            ...
            <p style={{
              ...
              Turn your skills into sustainable passive income. Sell premium digital assets on a platform purpose-built for creators.
            </p>
            ...
            <p style={{
              ...
              From templates and design kits to courses and code — Lumora gives you everything you need to launch, sell, and scale.
            </p>
            ...
            >
              ...
              <div style={{ position: 'relative', zIndex: 1 }}>
                ...
                <p style={{
                  ...
                  Launch your digital products on Lumora and reach thousands of customers worldwide.
                </p>
                <button
