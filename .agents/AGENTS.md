...
- **NEVER** complete a task involving file modifications without automatically staging, committing, and pushing the changes to the repository.
- The commit message must always be highly detailed, structured, and explain exactly what changes were made (e.g. using bullet points).
